...
#define FFMPEG_CONFIGURATION "--x86asmexe=yasm --extra-ldflags=' -L../../../thirdparty/64/lib' --extra-cflags='-fno-tree-vectorize -D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -gdwarf-2 -fno-omit-frame-pointer -I../../../thirdparty/64/include' --pkg-config-flags='--static --define-variable=prefix=../../../thirdparty/64' --enable-shared --disable-static --enable-gpl --enable-version3 --enable-w32threads --disable-demuxer=matroska --disable-filters --enable-filter='scale,yadif,w3fdif' --disable-protocol='async,cache,concat,httpproxy,icecast,md5,subfile' --disable-muxers --enable-muxer=spdif --disable-bsfs --enable-bsf='extract_extradata,vp9_superframe_split' --disable-cuda --disable-cuda-llvm --disable-cuvid --disable-nvenc --disable-mediafoundation --enable-avresample --enable-avisynth --disable-avdevice --disable-postproc --enable-swresample --disable-encoders --disable-devices --disable-programs --disable-doc --build-suffix=-lav --arch=x86_64 --enable-libdav1d --enable-libspeex --enable-libopencore-amrnb --enable-libopencore-amrwb --disable-debug --disable-schannel --enable-gnutls --enable-libxml2 --disable-stripping --enable-gmp --enable-cross-compile --cross-prefix=x86_64-w64-mingw32- --target-os=mingw32 --pkg-config=pkg-config"
