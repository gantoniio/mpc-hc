...
#define FFMPEG_CONFIGURATION "--x86asmexe=yasm --extra-ldflags=' -L../../../thirdparty/64/lib' --extra-cflags='-fno-tree-vectorize -D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -gdwarf-2 -fno-omit-frame-pointer -I../../../thirdparty/64/include' --pkg-config-flags='--static --define-variable=prefix=../../../thirdparty/64' --enable-gpl --enable-version3 --enable-w32threads --enable-static --disable-shared --disable-everything --disable-mediafoundation --disable-schannel --disable-dxva2 --disable-d3d11va --disable-programs --disable-doc --disable-avformat --disable-avdevice --disable-devices --disable-postproc --disable-swscale --enable-filter='abuffer,abuffersink,atempo,aresample' --arch=x86_64 --enable-cross-compile --cross-prefix=x86_64-w64-mingw32- --target-os=mingw32 --pkg-config=pkg-config"
