...
static constexpr wmcmd_base default_wmcmds[] = {
    ...
    { CMDID(PLAY_FRAMESTEPCANCEL),       VK_LEFT, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_MPLAYERC_16 },
    ...
    { CMDID(SHIFT_SUB_DOWN),             VK_NEXT, FVIRTKEY | FALT | FNOINVERT,             IDS_MPLAYERC_102 },
    { CMDID(SHIFT_SUB_UP),              VK_PRIOR, FVIRTKEY | FALT | FNOINVERT,             IDS_MPLAYERC_103 },
...
void CAppSettings::LoadSettings()
{
    ...
    bUseLegacyToolbar = !!pApp->GetProfileInt(IDS_R_SETTINGS, IDS_RS_USE_LEGACY_TOOLBAR, FALSE);
    {
        ...
        if (temp.IsEmpty()) {
            temp = _T("<PLAY_PLAY><PLAY_PAUSE><PLAY_STOP><BUTTONSEP><NAVIGATE_SKIPBACK><PLAY_DECRATE><PLAY_INCRATE><NAVIGATE_SKIPFORWARD><BUTTONSEP><PLAY_FRAMESTEP><BUTTONSEP><DUMMYSEPARATOR><VOLUME_MUTE>");
        }
        toolBarLayout <<= temp;
    }
