...
std::map<CStringA, DWORD> CAppSettings::CommandStrToID;
...
#define CMDID(X) #X, ID_##X

static constexpr wmcmd_base default_wmcmds[] = {
    { CMDID(FILE_OPENQUICK),                 'Q', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_MPLAYERC_0 },
    { CMDID(FILE_OPENMEDIA),                 'O', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_OPEN_FILE },
    { CMDID(FILE_OPENDVDBD),                 'D', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_OPEN_DVD },
    { CMDID(FILE_OPENDEVICE),                'V', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_OPEN_DEVICE },
    { CMDID(FILE_REOPEN),                    'E', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_REOPEN },
    { CMDID(FILE_RECYCLE),             VK_DELETE, FVIRTKEY | FNOINVERT,                    IDS_FILE_RECYCLE },

    { CMDID(FILE_SAVE_COPY),                   0, FVIRTKEY | FNOINVERT,                    IDS_AG_SAVE_COPY },
    { CMDID(FILE_SAVE_IMAGE),                'I', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_SAVE_IMAGE },
    { CMDID(FILE_SAVE_IMAGE_AUTO),         VK_F5, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_6 },
    { CMDID(FILE_SAVE_THUMBNAILS),             0, FVIRTKEY | FNOINVERT,                    IDS_FILE_SAVE_THUMBNAILS },

    { CMDID(FILE_SUBTITLES_LOAD),            'L', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_LOAD_SUBTITLES },
    { CMDID(FILE_SUBTITLES_SAVE),            'S', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_SAVE_SUBTITLES },
    { CMDID(FILE_SUBTITLES_DOWNLOAD),        'D', FVIRTKEY | FNOINVERT,                    IDS_SUBTITLES_DOWNLOAD },
    //{ CMDID(FILE_SUBTITLES_UPLOAD),          'U', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_SUBTITLES_UPLOAD },
    { CMDID(FILE_CLOSE_AND_RESTORE),         'C', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_CLOSE },
    { CMDID(FILE_PROPERTIES),             VK_F10, FVIRTKEY | FSHIFT | FNOINVERT,           IDS_AG_PROPERTIES },
    { CMDID(FILE_OPEN_LOCATION),          VK_F10, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT,IDS_AG_OPEN_FILE_LOCATION },
    { CMDID(FILE_EXIT),                      'X', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_EXIT },
    { CMDID(PLAY_PLAYPAUSE),            VK_SPACE, FVIRTKEY | FNOINVERT,                    IDS_AG_PLAYPAUSE,   APPCOMMAND_MEDIA_PLAY_PAUSE, wmcmd::LUP, wmcmd::LUP },
    { CMDID(PLAY_PLAY),                        0, FVIRTKEY | FNOINVERT,                    IDS_AG_PLAY,        APPCOMMAND_MEDIA_PLAY },
    { CMDID(PLAY_PAUSE),                       0, FVIRTKEY | FNOINVERT,                    IDS_AG_PAUSE,       APPCOMMAND_MEDIA_PAUSE },
    { CMDID(PLAY_STOP),            VK_OEM_PERIOD, FVIRTKEY | FNOINVERT,                    IDS_AG_STOP,        APPCOMMAND_MEDIA_STOP },
    { CMDID(PLAY_FRAMESTEP),            VK_RIGHT, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_FRAMESTEP },
    { CMDID(PLAY_FRAMESTEP_BACK),       VK_LEFT, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_MPLAYERC_16 },
    { CMDID(NAVIGATE_GOTO),                  'G', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_GO_TO },
    { CMDID(PLAY_INCRATE),                 VK_UP, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_INCREASE_RATE },
    { CMDID(PLAY_DECRATE),               VK_DOWN, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_DECREASE_RATE },
    { CMDID(PLAY_RESETRATE),                 'R', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_RESET_RATE },
    { CMDID(PLAY_INCAUDDELAY),            VK_ADD, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_21 },
    { CMDID(PLAY_DECAUDDELAY),       VK_SUBTRACT, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_22 },
    { CMDID(PLAY_SEEKFORWARDSMALL),            0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_23 },
    { CMDID(PLAY_SEEKBACKWARDSMALL),           0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_24 },
    { CMDID(PLAY_SEEKFORWARDMED),       VK_RIGHT, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_25 },
    { CMDID(PLAY_SEEKBACKWARDMED),       VK_LEFT, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_26 },
    { CMDID(PLAY_SEEKFORWARDLARGE),            0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_27, 0, wmcmd::WUP,   wmcmd::WUP,   FVIRTKEY | FCONTROL, FVIRTKEY | FCONTROL },
    { CMDID(PLAY_SEEKBACKWARDLARGE),           0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_28, 0, wmcmd::WDOWN, wmcmd::WDOWN, FVIRTKEY | FCONTROL, FVIRTKEY | FCONTROL },
    { CMDID(PLAY_SEEKKEYFORWARD),       VK_RIGHT, FVIRTKEY | FSHIFT | FNOINVERT,           IDS_MPLAYERC_29 },
    { CMDID(PLAY_SEEKKEYBACKWARD),       VK_LEFT, FVIRTKEY | FSHIFT | FNOINVERT,           IDS_MPLAYERC_30 },
    { CMDID(PLAY_SEEKSET),               VK_HOME, FVIRTKEY | FNOINVERT,                    IDS_AG_SEEKSET },
    { CMDID(PLAY_REPEAT_FOREVER),              0, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOP_FOREVER },
    { CMDID(PLAY_REPEAT_ONEFILE),              0, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOPMODE_FILE },
    { CMDID(PLAY_REPEAT_WHOLEPLAYLIST),        0, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOPMODE_PLAYLIST },
    { CMDID(PLAY_REPEAT_AB),                   0, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOPMODE_AB },
    { CMDID(PLAY_REPEAT_AB_MARK_A),     VK_OEM_4, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOPMODE_AB_MARK_A },
    { CMDID(PLAY_REPEAT_AB_MARK_B),     VK_OEM_6, FVIRTKEY | FNOINVERT,                    IDS_PLAYLOOPMODE_AB_MARK_B },
    { CMDID(NAVIGATE_SKIPFORWARD),       VK_NEXT, FVIRTKEY | FNOINVERT,                    IDS_AG_NEXT,        APPCOMMAND_MEDIA_NEXTTRACK, wmcmd::X2DOWN, wmcmd::X2DOWN },
    { CMDID(NAVIGATE_SKIPBACK),         VK_PRIOR, FVIRTKEY | FNOINVERT,                    IDS_AG_PREVIOUS,    APPCOMMAND_MEDIA_PREVIOUSTRACK, wmcmd::X1DOWN, wmcmd::X1DOWN },
    { CMDID(NAVIGATE_SKIPFORWARDFILE),   VK_NEXT, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_NEXT_FILE },
    { CMDID(NAVIGATE_SKIPBACKFILE),     VK_PRIOR, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PREVIOUS_FILE },
    { CMDID(NAVIGATE_TUNERSCAN),             'T', FVIRTKEY | FSHIFT | FNOINVERT,           IDS_NAVIGATE_TUNERSCAN },
    { CMDID(FAVORITES_QUICKADDFAVORITE),     'Q', FVIRTKEY | FSHIFT | FNOINVERT,           IDS_FAVORITES_QUICKADDFAVORITE },
    { CMDID(FAVORITES_ORGANIZE),              0,  FVIRTKEY | FNOINVERT,                    IDS_FAVORITES_ORGANIZE },
    { CMDID(VIEW_CAPTIONMENU),               '0', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_CAPTION },
    { CMDID(VIEW_SEEKER),                    '1', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_SEEKER },
    { CMDID(VIEW_CONTROLS),                  '2', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_CONTROLS },
    { CMDID(VIEW_INFORMATION),               '3', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_INFO },
    { CMDID(VIEW_STATISTICS),                '4', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_STATS },
    { CMDID(VIEW_STATUS),                    '5', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_STATUS },
    { CMDID(VIEW_SUBRESYNC),                 '6', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_SUBRESYNC },
    { CMDID(VIEW_PLAYLIST),                  '7', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_PLAYLIST },
    { CMDID(VIEW_CAPTURE),                   '8', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_CAPTURE },
    { CMDID(VIEW_NAVIGATION),                '9', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TOGGLE_NAVIGATION },
    { CMDID(VIEW_DEBUGSHADERS),                0, FVIRTKEY | FNOINVERT,                    IDS_AG_TOGGLE_DEBUGSHADERS },
    { CMDID(PRESIZE_SHADERS_TOGGLE),         'P', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_PRESIZE_SHADERS_TOGGLE },
    { CMDID(POSTSIZE_SHADERS_TOGGLE),        'P', FVIRTKEY | FCONTROL | FALT | FNOINVERT,  IDS_POSTSIZE_SHADERS_TOGGLE },
    { CMDID(VIEW_MPCTHEME),                    0, FVIRTKEY | FNOINVERT,                    IDS_AG_TOGGLE_MPCTHEME },
    { CMDID(SUBTITLES_DEFAULT_STYLE),          0, FVIRTKEY | FNOINVERT,                    IDS_AG_TOGGLE_DEFAULT_SUBTITLE_STYLE },
    { CMDID(VIEW_PRESETS_MINIMAL),           '1', FVIRTKEY | FNOINVERT,                    IDS_AG_VIEW_MINIMAL },
    { CMDID(VIEW_PRESETS_COMPACT),           '2', FVIRTKEY | FNOINVERT,                    IDS_AG_VIEW_COMPACT },
    { CMDID(VIEW_PRESETS_NORMAL),            '3', FVIRTKEY | FNOINVERT,                    IDS_AG_VIEW_NORMAL },
    { CMDID(VIEW_FULLSCREEN),          VK_RETURN, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_FULLSCREEN, 0, wmcmd::LDBLCLK, wmcmd::LDBLCLK },
    { CMDID(VIEW_FULLSCREEN_SECONDARY),   VK_F11, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_39 },
    { CMDID(VIEW_ZOOM_25),              VK_OEM_3, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_25 }, /* VK_OEM_3 is `~ on US keyboards*/
    { CMDID(VIEW_ZOOM_50),                   '1', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_50 },
    { CMDID(VIEW_ZOOM_100),                  '2', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_100 },
    { CMDID(VIEW_ZOOM_200),                  '3', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_200 },
    { CMDID(VIEW_ZOOM_AUTOFIT),              '4', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_AUTO_FIT },
    { CMDID(VIEW_ZOOM_AUTOFIT_LARGER),       '5', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_ZOOM_AUTO_FIT_LARGER },
    { CMDID(VIEW_ZOOM_ADD),                    0, FVIRTKEY | FNOINVERT,                    IDS_AG_ZOOM_ADD },
    { CMDID(VIEW_ZOOM_SUB),                    0, FVIRTKEY | FNOINVERT,                    IDS_AG_ZOOM_SUB },
    { CMDID(ASPECTRATIO_NEXT),                 0, FVIRTKEY | FNOINVERT,                    IDS_AG_NEXT_AR_PRESET },
    { CMDID(VIEW_VF_HALF),                     0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_HALF },
    { CMDID(VIEW_VF_NORMAL),                   0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_NORMAL },
    { CMDID(VIEW_VF_DOUBLE),                   0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_DOUBLE },
    { CMDID(VIEW_VF_STRETCH),                  0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_STRETCH },
    { CMDID(VIEW_VF_FROMINSIDE),               0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_INSIDE },
    { CMDID(VIEW_VF_ZOOM1),                    0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_ZOOM1 },
    { CMDID(VIEW_VF_ZOOM2),                    0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_ZOOM2 },
    { CMDID(VIEW_VF_FROMOUTSIDE),              0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_OUTSIDE },
    { CMDID(VIEW_VF_SWITCHZOOM),               0, FVIRTKEY | FNOINVERT,                    IDS_AG_VIDFRM_SWITCHZOOM },
    { CMDID(ONTOP_ALWAYS),                   'A', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_ALWAYS_ON_TOP },
    { CMDID(VIEW_RESET),              VK_NUMPAD5, FVIRTKEY | FNOINVERT,                    IDS_AG_PNS_RESET },
    { CMDID(VIEW_INCSIZE),            VK_NUMPAD9, FVIRTKEY | FNOINVERT,                    IDS_AG_PNS_INC_SIZE },
    { CMDID(VIEW_INCWIDTH),           VK_NUMPAD6, FVIRTKEY | FNOINVERT,                    IDS_AG_PNS_INC_WIDTH },
    { CMDID(VIEW_INCHEIGHT),          VK_NUMPAD8, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_47 },
    { CMDID(VIEW_DECSIZE),            VK_NUMPAD1, FVIRTKEY | FNOINVERT,                    IDS_AG_PNS_DEC_SIZE },
    { CMDID(VIEW_DECWIDTH),           VK_NUMPAD4, FVIRTKEY | FNOINVERT,                    IDS_AG_PNS_DEC_WIDTH },
    { CMDID(VIEW_DECHEIGHT),          VK_NUMPAD2, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_50 },
    { CMDID(PANSCAN_CENTER),          VK_NUMPAD5, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_CENTER },
    { CMDID(PANSCAN_MOVELEFT),        VK_NUMPAD4, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_LEFT },
    { CMDID(PANSCAN_MOVERIGHT),       VK_NUMPAD6, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_RIGHT },
    { CMDID(PANSCAN_MOVEUP),          VK_NUMPAD8, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_UP },
    { CMDID(PANSCAN_MOVEDOWN),        VK_NUMPAD2, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_DOWN },
    { CMDID(PANSCAN_MOVEUPLEFT),      VK_NUMPAD7, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_UPLEFT },
    { CMDID(PANSCAN_MOVEUPRIGHT),     VK_NUMPAD9, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_UPRIGHT },
    { CMDID(PANSCAN_MOVEDOWNLEFT),    VK_NUMPAD1, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_PNS_DOWNLEFT },
    { CMDID(PANSCAN_MOVEDOWNRIGHT),   VK_NUMPAD3, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_MPLAYERC_59 },
    { CMDID(PANSCAN_ROTATEXP),        VK_NUMPAD8, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEX_P },
    { CMDID(PANSCAN_ROTATEXM),        VK_NUMPAD2, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEX_M },
    { CMDID(PANSCAN_ROTATEYP),        VK_NUMPAD4, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEY_P },
    { CMDID(PANSCAN_ROTATEYM),        VK_NUMPAD6, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEY_M },
    { CMDID(PANSCAN_ROTATEZP),        VK_NUMPAD1, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEZ_P },
    { CMDID(PANSCAN_ROTATEZM),        VK_NUMPAD3, FVIRTKEY | FALT | FNOINVERT,             IDS_AG_PNS_ROTATEZ_M },
    { CMDID(VOLUME_UP),                    VK_UP, FVIRTKEY | FNOINVERT,                    IDS_AG_VOLUME_UP,   0, wmcmd::WUP, wmcmd::WUP },
    { CMDID(VOLUME_DOWN),                VK_DOWN, FVIRTKEY | FNOINVERT,                    IDS_AG_VOLUME_DOWN, 0, wmcmd::WDOWN, wmcmd::WDOWN },
    { CMDID(VOLUME_MUTE),                    'M', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_VOLUME_MUTE, 0 },
    { CMDID(VOLUME_BOOST_INC),                 0, FVIRTKEY | FNOINVERT,                    IDS_VOLUME_BOOST_INC },
    { CMDID(VOLUME_BOOST_DEC),                 0, FVIRTKEY | FNOINVERT,                    IDS_VOLUME_BOOST_DEC },
    { CMDID(VOLUME_BOOST_MIN),                 0, FVIRTKEY | FNOINVERT,                    IDS_VOLUME_BOOST_MIN },
    { CMDID(VOLUME_BOOST_MAX),                 0, FVIRTKEY | FNOINVERT,                    IDS_VOLUME_BOOST_MAX },
    { CMDID(CUSTOM_CHANNEL_MAPPING),           0, FVIRTKEY | FNOINVERT,                    IDS_CUSTOM_CHANNEL_MAPPING },
    { CMDID(NORMALIZE),                        0, FVIRTKEY | FNOINVERT,                    IDS_NORMALIZE },
    { CMDID(REGAIN_VOLUME),                    0, FVIRTKEY | FNOINVERT,                    IDS_REGAIN_VOLUME },
    { CMDID(COLOR_BRIGHTNESS_INC),             0, FVIRTKEY | FNOINVERT,                    IDS_BRIGHTNESS_INC },
    { CMDID(COLOR_BRIGHTNESS_DEC),             0, FVIRTKEY | FNOINVERT,                    IDS_BRIGHTNESS_DEC },
    { CMDID(COLOR_CONTRAST_INC),               0, FVIRTKEY | FNOINVERT,                    IDS_CONTRAST_INC },
    { CMDID(COLOR_CONTRAST_DEC),               0, FVIRTKEY | FNOINVERT,                    IDS_CONTRAST_DEC },
    { CMDID(COLOR_HUE_INC),                    0, FVIRTKEY | FNOINVERT,                    IDS_HUE_INC },
    { CMDID(COLOR_HUE_DEC),                    0, FVIRTKEY | FNOINVERT,                    IDS_HUE_DEC },
    { CMDID(COLOR_SATURATION_INC),             0, FVIRTKEY | FNOINVERT,                    IDS_SATURATION_INC },
    { CMDID(COLOR_SATURATION_DEC),             0, FVIRTKEY | FNOINVERT,                    IDS_SATURATION_DEC },
    { CMDID(COLOR_RESET),                      0, FVIRTKEY | FNOINVERT,                    IDS_RESET_COLOR },
    { CMDID(NAVIGATE_TITLEMENU),             'T', FVIRTKEY | FALT | FNOINVERT,             IDS_MPLAYERC_63 },
    { CMDID(NAVIGATE_ROOTMENU),              'R', FVIRTKEY | FALT | FNOINVERT,             IDS_AG_DVD_ROOT_MENU },
    { CMDID(NAVIGATE_SUBPICTUREMENU),          0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_65 },
    { CMDID(NAVIGATE_AUDIOMENU),               0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_66 },
    { CMDID(NAVIGATE_ANGLEMENU),               0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_67 },
    { CMDID(NAVIGATE_CHAPTERMENU),             0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_68 },
    { CMDID(NAVIGATE_MENU_LEFT),         VK_LEFT, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT,  IDS_AG_DVD_MENU_LEFT },
    { CMDID(NAVIGATE_MENU_RIGHT),       VK_RIGHT, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT,  IDS_MPLAYERC_70 },
    { CMDID(NAVIGATE_MENU_UP),             VK_UP, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT,  IDS_AG_DVD_MENU_UP },
    { CMDID(NAVIGATE_MENU_DOWN),         VK_DOWN, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT,  IDS_AG_DVD_MENU_DOWN },
    { CMDID(NAVIGATE_MENU_ACTIVATE),           0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_73 },
    { CMDID(NAVIGATE_MENU_BACK),               0, FVIRTKEY | FNOINVERT,                    IDS_AG_DVD_MENU_BACK },
    { CMDID(NAVIGATE_MENU_LEAVE),              0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_75 },
    { CMDID(BOSS),                           'B', FVIRTKEY | FNOINVERT,                    IDS_AG_BOSS_KEY },
    { CMDID(MENU_PLAYER_SHORT),          VK_APPS, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_77, 0, wmcmd::RUP, wmcmd::RUP },
    { CMDID(MENU_PLAYER_LONG),                 0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_78 },
    { CMDID(MENU_FILTERS),                     0, FVIRTKEY | FNOINVERT,                    IDS_AG_FILTERS_MENU },
    { CMDID(VIEW_OPTIONS),                   'O', FVIRTKEY | FNOINVERT,                    IDS_AG_OPTIONS },
    { CMDID(STREAM_AUDIO_NEXT),              'A', FVIRTKEY | FNOINVERT,                    IDS_AG_NEXT_AUDIO },
    { CMDID(STREAM_AUDIO_PREV),              'A', FVIRTKEY | FSHIFT | FNOINVERT,           IDS_AG_PREV_AUDIO },
    { CMDID(STREAM_SUB_NEXT),                'S', FVIRTKEY | FNOINVERT,                    IDS_AG_NEXT_SUBTITLE },
    { CMDID(STREAM_SUB_PREV),                'S', FVIRTKEY | FSHIFT | FNOINVERT,           IDS_AG_PREV_SUBTITLE },
    { CMDID(STREAM_SUB_ONOFF),               'W', FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_85 },
    { "", ID_SUBTITLES_SUBITEM_START + 2,      0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_86 },
    { CMDID(DVD_ANGLE_NEXT),                   0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_91 },
    { CMDID(DVD_ANGLE_PREV),                   0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_92 },
    { CMDID(DVD_AUDIO_NEXT),                   0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_93 },
    { CMDID(DVD_AUDIO_PREV),                   0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_94 },
    { CMDID(DVD_SUB_NEXT),                     0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_95 },
    { CMDID(DVD_SUB_PREV),                     0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_96 },
    { CMDID(DVD_SUB_ONOFF),                    0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_97 },
    { CMDID(VIEW_TEARING_TEST),              'T', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_AG_TEARING_TEST },
    { CMDID(VIEW_OSD_DISPLAY_TIME),          'I', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_OSD_DISPLAY_CURRENT_TIME },
    { CMDID(VIEW_OSD_SHOW_FILENAME),         'N', FVIRTKEY | FNOINVERT,                    IDS_OSD_SHOW_FILENAME },
    { CMDID(SHADERS_PRESET_NEXT),              0, FVIRTKEY | FNOINVERT,                    IDS_AG_SHADERS_PRESET_NEXT },
    { CMDID(SHADERS_PRESET_PREV),              0, FVIRTKEY | FNOINVERT,                    IDS_AG_SHADERS_PRESET_PREV },
    { CMDID(D3DFULLSCREEN_TOGGLE),             0, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_99 },
    { CMDID(GOTO_PREV_SUB),                  'Y', FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_100 },
    { CMDID(GOTO_NEXT_SUB),                  'U', FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_101 },
    { CMDID(SUBRESYNC_SHIFT_DOWN),       VK_NEXT, FVIRTKEY | FALT | FNOINVERT,             IDS_MPLAYERC_102 },
    { CMDID(SUBRESYNC_SHIFT_UP),        VK_PRIOR, FVIRTKEY | FALT | FNOINVERT,             IDS_MPLAYERC_103 },
    { CMDID(VIEW_DISPLAY_RENDERER_STATS),    'J', FVIRTKEY | FCONTROL | FNOINVERT,         IDS_OSD_DISPLAY_RENDERER_STATS },
    { CMDID(VIEW_RESET_RENDERER_STATS),      'R', FVIRTKEY | FCONTROL | FALT | FNOINVERT,  IDS_OSD_RESET_RENDERER_STATS },
    { CMDID(VIEW_VSYNC),                     'V', FVIRTKEY | FNOINVERT,                    IDS_AG_VSYNC },
    { CMDID(VIEW_ENABLEFRAMETIMECORRECTION),   0, FVIRTKEY | FNOINVERT,                    IDS_AG_ENABLEFRAMETIMECORRECTION },
    { CMDID(VIEW_VSYNCACCURATE),             'V', FVIRTKEY | FCONTROL | FALT | FNOINVERT,  IDS_AG_VSYNCACCURATE },
    { CMDID(VIEW_VSYNCOFFSET_DECREASE),    VK_UP, FVIRTKEY | FCONTROL | FALT | FNOINVERT,  IDS_AG_VSYNCOFFSET_DECREASE },
    { CMDID(VIEW_VSYNCOFFSET_INCREASE),  VK_DOWN, FVIRTKEY | FCONTROL | FALT | FNOINVERT,  IDS_AG_VSYNCOFFSET_INCREASE },
    { CMDID(SUB_DELAY_DOWN),               VK_F1, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_104 },
    { CMDID(SUB_DELAY_UP),                 VK_F2, FVIRTKEY | FNOINVERT,                    IDS_MPLAYERC_105 },
    { CMDID(SUB_POS_DOWN),           VK_SUBTRACT, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT, IDS_SUB_POS_DOWN },
    { CMDID(SUB_POS_UP),                  VK_ADD, FVIRTKEY | FCONTROL | FSHIFT | FNOINVERT, IDS_SUB_POS_UP },
    { CMDID(SUB_FONT_SIZE_DEC),      VK_SUBTRACT, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_SUB_FONT_SIZE_DEC },
    { CMDID(SUB_FONT_SIZE_INC),           VK_ADD, FVIRTKEY | FCONTROL | FNOINVERT,         IDS_SUB_FONT_SIZE_INC },

    { CMDID(AFTERPLAYBACK_DONOTHING),          0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_DONOTHING },
    { CMDID(AFTERPLAYBACK_PLAYNEXT),           0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_PLAYNEXT },
    { CMDID(AFTERPLAYBACK_MONITOROFF),         0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_MONITOROFF },
    { CMDID(AFTERPLAYBACK_EXIT),               0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_EXIT },
    { CMDID(AFTERPLAYBACK_STANDBY),            0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_STANDBY },
    { CMDID(AFTERPLAYBACK_HIBERNATE),          0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_HIBERNATE },
    { CMDID(AFTERPLAYBACK_SHUTDOWN),           0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_SHUTDOWN },
    { CMDID(AFTERPLAYBACK_LOGOFF),             0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_LOGOFF },
    { CMDID(AFTERPLAYBACK_LOCK),               0, FVIRTKEY | FNOINVERT,                    IDS_AFTERPLAYBACK_LOCK },

    { CMDID(VIEW_EDITLISTEDITOR),              0, FVIRTKEY | FNOINVERT,                    IDS_AG_TOGGLE_EDITLISTEDITOR },
    { CMDID(EDL_IN),                           0, FVIRTKEY | FNOINVERT,                    IDS_AG_EDL_IN },
    { CMDID(EDL_OUT),                          0, FVIRTKEY | FNOINVERT,                    IDS_AG_EDL_OUT },
    { CMDID(EDL_NEWCLIP),                      0, FVIRTKEY | FNOINVERT,                    IDS_AG_EDL_NEW_CLIP },
    { CMDID(EDL_SAVE),                         0, FVIRTKEY | FNOINVERT,                    IDS_AG_EDL_SAVE }
};

void CAppSettings::CreateCommands()
{
    CommandStrToID.clear();
    for (const auto& wc : default_wmcmds) {
        CommandStrToID[wc.cmdidStr] = wc.cmd;
        CommandIDToWMCMD[wc.cmd] = &wc;
        wmcmds.AddTail(wmcmd(wc));
    }
    CommandStrToID["DUMMYSEPARATOR"] = ID_DUMMYSEPARATOR;
    CommandStrToID["BUTTONSEP"] = ID_BUTTONSEP;
}
...
void CAppSettings::SaveSettings(bool write_full_history /* = false */)
{
    ...
    CString toolbarLayout;
    pApp->WriteProfileString(IDS_R_SETTINGS, IDS_RS_TOOLBAR_LAYOUT, toolbarLayout <<= toolBarLayout);
