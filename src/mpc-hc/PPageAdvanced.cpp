...
void CPPageAdvanced::InitSettings()
{
    ...
    addBoolItem(MPCTHEME_FILL_SEEK_BAR_AND_VOLUME, IDS_RS_MPCTHEMEFILLSEEKBARANDVOLUME, true, s.bMPCThemeFillSeekbarAndVolume, _T("Fill seek bar and volume from left to right, instead of showing dragger"));
}
